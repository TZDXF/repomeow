...
pub mod codes {
    ...
    pub const MARKETPLACE_RATE_LIMITED: &str = "resource_library_marketplace_rate_limited";
    ...
    pub const CLONE_TIMEOUT: &str = "resource_library_clone_timeout";
    pub const REPO_TOO_LARGE: &str = "resource_library_repo_too_large";
}
