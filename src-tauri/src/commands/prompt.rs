...
// 旧版本曾支持自定义的 wiki 提示词文件,现已固定为前端内置模板;保存时顺带清理避免遗留文件被误认为仍生效
const LEGACY_WIKI_OUTLINE_PROMPT_FILE: &str = "wiki-outline.md";
const LEGACY_WIKI_PAGE_PROMPT_FILE: &str = "wiki-page.md";
