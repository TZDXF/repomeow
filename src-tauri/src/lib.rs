...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::files::watch_project_files,
            commands::files::unwatch_project_files,
            commands::files::project_file_exists,
            ...
            commands::toolchain::check_toolchain_update,
            ...
            commands::ai::project_ai_targets,
            commands::ai::project_ai_resources,
            ...
            commands::ai::rl_skill_group_set_skills,
            commands::ai::rl_skill_open_dir,
            commands::ai::rl_skill_create,
            commands::ai::rl_skill_update,
            commands::ai::rl_skill_delete,
            commands::ai::rl_skill_import_folder,
            commands::ai::rl_skill_import_archive,
            commands::ai::rl_skill_import_url,
