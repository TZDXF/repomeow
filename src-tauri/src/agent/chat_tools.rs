...
use crate::commands::ai::{
    ...
    GenerateWikiRequest, UpdateWikiRequest, WikiGenerationBackend, WikiGenerationEvent,
    WikiUpdateEvent,
};
...
fn get_ai_config_tool(app: &AppHandle, ctx: &ChatToolContext) -> AgentTool {
    tool(
        "get_ai_config",
        "AI 配置",
...
fn set_wiki_model_tool(app: &AppHandle, ctx: &ChatToolContext) -> AgentTool {
    tool(
        "set_wiki_model",
        "切换 Wiki 模型",
