  ...
  git: {
    ...
    graph: {
      ...
      analysis: {
        ...
        trend: "Commit trend (weekly)",
        trendCell: "Week of {week}: {count} commits",
        churnTrend: "Code churn (weekly)",
        churnCell: "Week of {week}: +{adds} / −{dels} lines",
        churnAdds: "Added lines",
        churnDels: "Deleted lines",
