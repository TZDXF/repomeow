  ...
  settings: {
    ...
    resources: {
      ...
      skills: {
        ...
        upToDate: "All marketplace skills are up to date",
        ...
        groups: {
          title: "Skill groups",
          description:
            "Create, rename, delete, and reorder groups. A skill can belong to multiple groups.",
        ...
        previewDialog: {
          loadBodyFailed: "Failed to load SKILL.md: {error}",
          emptyBody: "This skill has no SKILL.md body yet.",
      ...
      mcp: {
        ...
        editDialog: {
          ...
          argsPlaceholder: "# comments and empty lines are ignored\n-m",
          ...
          headersLabel: "Headers (Header: value, one per line)",
          headersPlaceholder: "Authorization: Bearer xxx",
          missingCommand: "Please enter the launch command",
